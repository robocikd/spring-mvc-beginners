...
public class CartRestController {
    ...
    public void addItem(@PathVariable String productId, HttpServletRequest request) {
        ...
        if (product == null) {
            throw new IllegalArgumentException(new ProductNoFoundException(productId));
        }
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST, reason = "Niepoprawne żądanie, sprawdź przysłane dane")
    public void handleClientException(Exception exception) {
